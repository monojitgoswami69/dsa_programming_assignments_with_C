...
> **Note:** This README is identical to [assignment_3/README.md](https://github.com/monojitgoswami69/dsa_programming_assignments_with_C/blob/main/assignment_3/README.md) as both assignments cover the same Queue data structure concept.
