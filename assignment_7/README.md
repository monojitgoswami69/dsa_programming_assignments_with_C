...
> **Note:** This README is identical to [assignment_6/README.md](https://github.com/monojitgoswami69/dsa_programming_assignments_with_C/blob/main/assignment_6/README.md) as both assignments cover the same Linked List data structure concept (including Singly, Doubly, and Circular variants).
